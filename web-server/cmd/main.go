...
func main() {
	...
	http.HandleFunc("/list", ListGames)
...
func GetRoot(w http.ResponseWriter, r *http.Request) {
	games, err := JsonRootGameInfo(jsonFile)
	if err != nil {
		log.Fatalln(err)
	}
...
func GetGame(w http.ResponseWriter, r *http.Request) {
	...
	games, err := JsonGameInfo(jsonFile)
	if err != nil {
		log.Fatalln(err)
	}
...
func ListGames(w http.ResponseWriter, r *http.Request) {
	...
	for _, g := range games {
		...
		listGames = append(listGames, (g.Game + "\n"))
	}
	err = Writer(w, "List of Games:\n")
	if err != nil {
		log.Println(err)
	}

	for _, v := range listGames {
		err := Writer(w, v)
		if err != nil {
			log.Println(err)
		}
